...
public class MyAccountConstants {
    ...
    public static final String TXT_EMAIL_INPUT_ID = "id:username";
    public static final String TXT_PASSWORD_INPUT_ID = "id:password";
    public static final String BTN_LOGIN = "xpath://input[@name='login']";

    public static final String LBL_ERROR_LOGIN = "xpath://li[contains(text(), '%s')]";
